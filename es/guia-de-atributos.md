...
{% hint style="info" %}
Esta guía enumera los multiplicadores de nivel y las tiradas de atributos para los objetos de equipamiento.
{% endhint %}
...
| Atributo | Máximo base | Categorías elegibles |
| --- | ---: | --- |
...
Generado a partir de rarityAttributes.lua; no edite manualmente las filas de atributos.
