...
- **Any member can donate.** The minimum donation is **1,000 gold**, taken from your inventory and your bank balance together.
...
Each buff is unlocked by a guild level and then grows with it. A buff always runs at the **full bonus your guild level supports** — gold buys uptime, not strength.

| Buff | Effect | Unlocks at | Bonus at unlock | Max (level 100) |
|---|---|---|---|---|
| **Magic Level** | Magic level advances faster | 5 | +2% | +15% |
| **Skills** | Weapon and shielding skills advance faster | 10 | +2% | +15% |
| **Experience** | More experience from kills | 15 | +2% | +15% |
| **Elite Monster Chance** | Higher chance for monsters to spawn as Elite | 20 | +2% | +7.5% |
| **Loot** | More loot from monsters | 25 | +4% | +15% |

## 📊 Bonus by Guild Level

Up to level 50 each bracket adds **+2%** (**+1%** for Elite Monster Chance). After 50 the curve continues at half that rate, **+1%** per bracket (**+0.5%** for Elite), to the maximum at level 100.

| Guild level | Magic Level | Skills | Experience | Elite Monster Chance | Loot |
|---|---|---|---|---|---|
| **5** | +2% | — | — | — | — |
| **10** | +2% | +2% | — | — | — |
| **15** | +2% | +2% | +2% | — | — |
...
- Buffs are sold in **15-minute blocks**. A guild may hold up to **120 minutes** of a single buff at once.
...
### Example: a 20-member guild

The actual price a 20-member guild pays, for its first purchase of the day.
...
| Blocks bought today | 1 | 2 | 3 | 4 | 5 | 6 | 7 | 8 |
|---|---|---|---|---|---|---|---|---|
| Price multiplier | ×1 | ×1.5 | ×2.25 | ×3.38 | ×5.06 | ×7.59 | ×11.39 | ×17.09 |

{% hint style="warning" %}
Filling all 120 minutes in one day therefore costs **49.26×** a single block — deliberately far more than 8 times it.
{% endhint %}

## 🏦 Gold Needed for Every Guild Level

Cost of the next level, and the running total donated since level 1.

| Level | Cost of next level | Total from level 1 |
|---|---|---|
| 1 → 2 | 10,000 | 10,000 |
| 2 → 3 | 22,973 | 32,973 |
| 3 → 4 | 37,371 | 70,344 |
...
{% hint style="success" %}
Reaching level 50 — where the first cap lands — takes **24,304,075 gold**, and maxing the guild at level 100 takes **112,922,637 gold** in total.
{% endhint %}
