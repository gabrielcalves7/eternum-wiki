...
- **Wpłacać może każdy członek.** Minimalna wpłata to **1,000 złota**, pobierane łącznie z ekwipunku i z banku.
...
Każde wzmocnienie odblokowuje się na danym poziomie gildii i rośnie razem z nim. Wzmocnienie zawsze działa na **maksimum, na które pozwala poziom gildii** — złoto kupuje czas, nie moc.

| Wzmocnienie | Efekt | Odblokowanie | Wartość na starcie | Maksimum (poziom 100) |
|---|---|---|---|---|
| **Magic Level** | Szybszy przyrost magic level | 5 | +2% | +15% |
| **Skills** | Szybszy przyrost skilli broni i shieldingu | 10 | +2% | +15% |
| **Experience** | Więcej doświadczenia za zabicia | 15 | +2% | +15% |
| **Elite Monster Chance** | Większa szansa na potwory Elite | 20 | +2% | +7.5% |
| **Loot** | Więcej lootu z potworów | 25 | +4% | +15% |

## 📊 Wzmocnienia Według Poziomu Gildii

Do poziomu 50 każdy przedział dodaje **+2%** (**+1%** dla szansy na potwora Elite). Powyżej 50 krzywa biegnie o połowę wolniej, **+1%** na przedział (**+0.5%** dla Elite), aż do maksimum na poziomie 100.

| Poziom gildii | Magic Level | Skills | Experience | Elite Monster Chance | Loot |
|---|---|---|---|---|---|
| **5** | +2% | — | — | — | — |
| **10** | +2% | +2% | — | — | — |
| **15** | +2% | +2% | +2% | — | — |
...
- Wzmocnienia sprzedawane są w **blokach po 15 minut**. Gildia może zgromadzić najwyżej **120 minut** jednego wzmocnienia.
...
### Przykład: gildia licząca 20 członków

Rzeczywista cena dla gildii liczącej 20 członków, przy pierwszym zakupie danego dnia.
...
| Bloki kupione dzisiaj | 1 | 2 | 3 | 4 | 5 | 6 | 7 | 8 |
|---|---|---|---|---|---|---|---|---|
| Mnożnik ceny | ×1 | ×1.5 | ×2.25 | ×3.38 | ×5.06 | ×7.59 | ×11.39 | ×17.09 |

{% hint style="warning" %}
Zapełnienie wszystkich 120 minut jednego dnia kosztuje więc **49.26×** jeden blok — celowo znacznie więcej niż 8 razy.
{% endhint %}

## 🏦 Złoto Potrzebne na Każdy Poziom Gildii

Koszt następnego poziomu i suma wpłacona od poziomu 1.

| Poziom | Koszt następnego poziomu | Łącznie od poziomu 1 |
|---|---|---|
| 1 → 2 | 10,000 | 10,000 |
| 2 → 3 | 22,973 | 32,973 |
| 3 → 4 | 37,371 | 70,344 |
...
{% hint style="success" %}
Dojście do poziomu 50 — gdzie kończy się pierwszy pułap — kosztuje **24,304,075 złota**, a maksymalny poziom 100 to łącznie **112,922,637 złota**.
{% endhint %}
